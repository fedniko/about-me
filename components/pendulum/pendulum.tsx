...
export default function Pendulum() {
  ...
  function polylineLengthPlus() {
    const newLength = parseInt(input.current.value, 10) + 20;
  ...
  function polylineLengthMinus() {
    const newLength = input.current.value - 20;
    input.current.value = newLength;
    polyline.current.setAttribute('points', `200,10 200,${newLength}`);
    circle.current.setAttribute('cy', `${newLength}`);
  }
        ...
        <Row>
          <Col className="d-flex flex-column align-items-center">
            ...
            <div className="pendulum__form">
              ...
              <button
                className="pendulum__form__button minus"
                id="btn-minus"
                type="button"
                onClick={() => polylineLengthMinus()}
              >
                -20
              </button>
              <input
              ...
              />
              <button
                className="pendulum__form__button"
                id="btn-plus"
                type="button"
                onClick={() => polylineLengthPlus()}
              >
                +20
              </button>
            </div>
